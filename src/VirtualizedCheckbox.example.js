...
export default class VirtualizedCheckboxExample extends Component {
  ...
  render() {
    const { hasOkButton, hasCancelButton, hasFilterBox } = this.state;
    const divStyle = {
    ...
    return (
      <div>
          ...
          <div style={{ margin: '1rem 0' }}>
            ...
            <label style={{ margin: '0 1rem' }}>
              <input
                type="checkbox"
                checked={hasOkButton}
                onChange={this.handleOkButtonToggle}
              />
              Toggle Ok button
            </label>
            <label style={{ margin: '0 1rem' }}>
              <input
                type="checkbox"
                checked={hasCancelButton}
                onChange={this.handleCancelButtonToggle}
              />
        ...
        <div>
          ...
          <div className={styles.description}>
            The scroll size is inherited from its parent. It is demonstrated
            below where VirtualizedCheckbox is in a ResizableBox component. Try
            it out.
          </div>
